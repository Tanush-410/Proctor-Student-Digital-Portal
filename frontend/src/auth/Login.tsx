    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-brand-700 via-brand-600 to-brand-900 lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-1/2 h-[26rem] w-[26rem] -translate-x-1/2 -translate-y-1/2 opacity-[0.12]"
        />
      ...
      <div className="relative flex items-center justify-center overflow-hidden bg-slate-50 px-4 py-12">
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 opacity-[0.05] lg:h-80 lg:w-80"
        />
